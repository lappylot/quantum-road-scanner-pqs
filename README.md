...
1. **Carrs Pharmacy**  
   - 📍 **Address:** 5600 Debarr Rd, Anchorage, AK 99504  
   - 📏 **Distance:** 2.5 miles  
   - ⏱️ **Estimated Travel Time:** 8 minutes  

2. **Walgreens Pharmacy**  
   - 📍 **Address:** 1477 W Northern Lights Blvd, Anchorage, AK 99503  
   - 📏 **Distance:** 3.1 miles  
   - ⏱️ **Estimated Travel Time:** 10 minutes  

3. **Fred Meyer Pharmacy**  
   - 📍 **Address:** 1000 E Northern Lights Blvd, Anchorage, AK 99508  
   - 📏 **Distance:** 3.8 miles  
   - ⏱️ **Estimated Travel Time:** 12 minutes  

4. **Alaska AIDS Assistance Association**  
   - 📍 **Address:** 1057 W Fireweed Ln, Suite 102, Anchorage, AK 99503  
   - 📏 **Distance:** 4.2 miles  
   - ⏱️ **Estimated Travel Time:** 15 minutes  

5. **The Alaskan AIDS Assistance Association (Four A's)**  
   - 📍 **Address:** 1057 W Fireweed Ln, Anchorage, AK 99503  
   - 📏 **Distance:** 4.5 miles  
   - ⏱️ **Estimated Travel Time:** 16 minutes  

---

## 🕒 Resource Availability

| Location                                | Hours                   | Pickup Method |
|-----------------------------------------|--------------------------|----------------|
| Carrs Pharmacy                          | 9 AM – 9 PM, Daily       | Walk-in        |
| Walgreens Pharmacy                      | 8 AM – 10 PM, Daily      | Walk-in        |
| Fred Meyer Pharmacy                     | 9 AM – 9 PM, Daily       | Walk-in        |
| Alaska AIDS Assistance Association      | 9 AM – 5 PM, Mon–Fri     | Walk-in        |
| The Alaskan AIDS Assistance (Four A's)  | 9 AM – 5 PM, Mon–Fri     | Walk-in        |

---

## 🚚 Emergency Delivery Options

- **Provider:** Anchorage Drug and Alcohol Information Service  
...
- **Recommended Route:** Use back roads and low-traffic paths for discretion.  
- **Method:** Consider ride-share or personal vehicle for privacy and speed.  
...
1. **Identify Overdose**
   - Signs: Unresponsive, shallow/no breathing, blue lips/fingertips.

2. **Call Emergency Services**
   - Dial `911` and clearly state your **location**.

3. **Perform Rescue Breathing**
   - Tilt head back, lift chin, and provide **two slow breaths**.

4. **Administer Naloxone**
   - Unpack the device.
   - Insert nozzle into nostril.
   - Press plunger to release dose.

5. **Monitor and Support**
   - No response in 2–3 minutes? **Repeat dose**.
